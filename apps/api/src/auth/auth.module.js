...
var jwt_strategy_1 = require("./jwt.strategy"); // <--- Ensure this file exists!
var AuthModule = function () {
    var _classDecorators = [(0, common_1.Global)(), (0, common_1.Module)({
            imports: [
                users_module_1.UsersModule,
                passport_1.PassportModule.register({ defaultStrategy: 'jwt' }), // <--- Explicitly set default
            ...
            controllers: [],
            providers: [auth_service_1.AuthService, jwt_strategy_1.JwtStrategy], // <--- Critical: Strategy must be here
