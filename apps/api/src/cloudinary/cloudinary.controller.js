...
var CloudinaryController = function () {
    ...
    var CloudinaryController = _classThis = /** @class */ (function () {
        function CloudinaryController_1(cloudinaryService) {
            this.cloudinaryService = (__runInitializers(this, _instanceExtraInitializers), cloudinaryService);
        }
        CloudinaryController_1.prototype.uploadImage = function (file) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.cloudinaryService.uploadFile(file)];
                });
            });
        };
        return CloudinaryController_1;
    }());
    __setFunctionName(_classThis, "CloudinaryController");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _uploadImage_decorators = [(0, common_1.Post)(), (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file'))];
