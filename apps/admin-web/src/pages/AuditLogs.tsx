    ...
    <div className="max-w-6xl mx-auto space-y-6 pb-20 relative">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="flex items-center gap-2 admin-input px-3 py-2">
          ...
          >
            ...
            <option value="VERIFICATION_STATUS_UPDATED">
      ...
      {loading ? (
        <div className="text-center py-20 text-slate-500 dark:text-gray-400">
          <Loader2 className="animate-spin inline mr-2" /> Loading audit logs...
        </div>
      ) : (
                  ...
                  <tr>
                    <td colSpan={4} className="px-6 py-10">
                      <EmptyState
                        title={
                          hasFilters
                            ? "No audit activity matches this view"
                        ...
                        actionLabel={
                          hasFilters ? "Clear filters" : "Refresh logs"
                        }
                        onAction={() => {
                          if (hasFilters) {
                            setSearchQuery("");
