        ...
        <form onSubmit={handleSubmit} className='space-y-6'>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            ...
            <Input
              ...
              onChange={handleChange}
              required
              placeholder='Affordable solar for everyone'
            />
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            <Input
              ...
              icon={FileText}
              onChange={handleChange}
              placeholder='e.g. 500 users, ₦1M revenue'
            />
            <Input
              label='Market Size'
              name='marketSize'
              icon={Target}
              onChange={handleChange}
              placeholder='e.g. 50M potential users in NG'
            />
          </div>
...
const Input = ({ label, icon: Icon, ...props }) => (
  <div>
    ...
    <div className='relative'>
      ...
      <input
        className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-brand-blue outline-none ${Icon ? 'pl-10' : ''}`}
        {...props}
      />
    </div>
  </div>
