...
const HowItWorks = () => {
  const steps = [
    ...
    },
    {
      ...
      text: "Once approved, your venture is listed on our secure platform where ethical investors browse.",
      icon: Users,
      tags: ["TECH", "AGRI", "RETAIL"],
    },
    {
      num: 3,
      title: "Growth & Profit Sharing",
      text: "Receive funds and mentorship. As your business grows, profits are shared according to the contract.",
      icon: TrendingUp,
    },
  ];
  ...
  return (
    <section
      className="bg-background-light py-16 dark:bg-background-dark md:py-24"
      id="how-it-works"
    >
      <div className="mx-auto max-w-[960px] px-4 sm:px-6">
        <div className="mb-12 text-center md:mb-16">
          <h2 className="mb-4 text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white md:text-5xl">
            The Naajih Path
          </h2>
          <p className="text-slate-500 dark:text-slate-400 max-w-lg mx-auto">
            From application to impact - a transparent journey designed for
            ethical success.
          </p>
        </div>
          ...
          {steps.map((step, idx) => (
            ...
            >
              <div className="flex flex-row md:flex-col items-center gap-4 md:gap-0">
                ...
                {idx !== 2 && (
                  <div className="hidden md:block w-0.5 bg-slate-300 dark:bg-slate-800 h-full mt-4 min-h-[100px]"></div>
                )}
              </div>
