...
const TrustSection = () => {
  return (
    <section className="relative overflow-hidden bg-deep-slate py-14 md:py-24" id="trust">
      ...
      <div className="relative z-10 mx-auto max-w-[1200px] px-4 sm:px-6">
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div>
            <h2 className="mb-5 text-3xl font-extrabold tracking-tight text-white md:mb-8 md:text-4xl">Financial Ethics, <span className="text-primary">Redefined.</span></h2>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6">
              {[
                ...
                <div key={item.t} className="rounded-xl border border-white/5 bg-background-dark/50 p-5 sm:p-6">
