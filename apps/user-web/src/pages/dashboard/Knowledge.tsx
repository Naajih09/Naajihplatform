...
const roleGuides = [
  {
    ...
    text: 'Start with Academy programs, join community discussions, and use mentor sessions to shape your idea before becoming an entrepreneur.',
  ...
  },
  {
    ...
    text: 'Complete verification, upgrade when ready to pitch, select the right investment type, and keep your funding ask and equity clear.',
  ...
  },
  {
    ...
    text: 'Set focus areas and investment preferences, review approved pitches, save interesting opportunities, and connect with founders.',
...
export default function Knowledge() {
  return (
    <div className="mx-auto max-w-6xl space-y-10 pb-20 text-slate-900 dark:text-white">
      ...
      <section>
        <h2 className="text-2xl font-black">Role Paths</h2>
