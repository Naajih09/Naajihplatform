...
var NotificationsGateway = function () {
    ...
    var _handleJoinNotifications_decorators;
    var NotificationsGateway = _classThis = /** @class */ (function () {
        ...
        NotificationsGateway_1.prototype.handleConnection = function (client) {
            console.log("Notification Client connected: ".concat(client.id));
        };
        NotificationsGateway_1.prototype.handleDisconnect = function (client) {
            console.log("Notification Client disconnected: ".concat(client.id));
        };
        NotificationsGateway_1.prototype.handleJoinNotifications = function (data, client) {
            client.join("notifications_".concat(data.userId));
            console.log("User ".concat(data.userId, " joined notification room"));
        };
        NotificationsGateway_1.prototype.sendNotification = function (userId, notification) {
            this.server.to("notifications_".concat(userId)).emit('notification_received', notification);
        };
    ...
    (function () {
        ...
        _handleJoinNotifications_decorators = [(0, websockets_1.SubscribeMessage)('join_notifications')];
        __esDecorate(_classThis, null, _handleJoinNotifications_decorators, { kind: "method", name: "handleJoinNotifications", static: false, private: false, access: { has: function (obj) { return "handleJoinNotifications" in obj; }, get: function (obj) { return obj.handleJoinNotifications; } }, metadata: _metadata }, null, _instanceExtraInitializers);
