...
var CloudinaryService = function () {
    ...
    var CloudinaryService = _classThis = /** @class */ (function () {
        ...
        CloudinaryService_1.prototype.uploadFile = function (file) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    console.log("\uD83D\uDE80 Starting upload for: ".concat(file.originalname, " (Size: ").concat(file.size, " bytes)"));
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            var upload = cloudinary_1.v2.uploader.upload_stream({
                                ...
                                console.log('✅ Upload Success:', result === null || result === void 0 ? void 0 : result.secure_url);
                                resolve(result);
                            });
