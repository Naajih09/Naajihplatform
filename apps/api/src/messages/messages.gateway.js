...
var MessagesGateway = function () {
    ...
    var MessagesGateway = _classThis = /** @class */ (function () {
        function MessagesGateway_1(messagesService, notificationsService) {
        ...
        MessagesGateway_1.prototype.handleJoinRoom = function (data, client) {
            client.join(data.userId);
            console.log("User ".concat(data.userId, " joined room"));
        };
        MessagesGateway_1.prototype.handleSendMessage = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                var message, sender, senderName;
                var _a, _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, this.messagesService.create(data)];
                        case 1:
                            message = _c.sent();
                            // Emit to receiver's room (Socket.io room for real-time chat)
                            this.server.to(data.receiverId).emit('receive_message', message);
                            return [4 /*yield*/, this.messagesService.databaseService.user.findUnique({
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, this.notificationsService.create(data.receiverId, "New message from ".concat(senderName, ": ").concat(data.content.substring(0, 20), "..."))];
                        case 3:
                            _c.sent();
