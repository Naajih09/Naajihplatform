...
var MessagesService = function () {
    ...
    var MessagesService = _classThis = /** @class */ (function () {
        function MessagesService_1(databaseService) {
        ...
        MessagesService_1.prototype.create = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.databaseService.message.create({
                            data: {
        ...
        MessagesService_1.prototype.getConversation = function (user1, user2) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.databaseService.message.findMany({
                            where: {
                                OR: [
        ...
        // 3. GET MY CHAT LIST 
        MessagesService_1.prototype.getMyChatPartners = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        MessagesService_1.prototype.markAsRead = function (messageId, userId) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.databaseService.message.findUnique({
                                where: { id: messageId },
                            })];
                        case 1:
                            message = _a.sent();
                            ...
                            if (message.receiverId !== userId) {
                                throw new common_1.UnauthorizedException('You can only read messages sent to you');
                            }
                            return [2 /*return*/, this.databaseService.message.update({
                                    where: { id: messageId },
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, this.databaseService.message.delete({
                                    where: { id: messageId },
                                })];
                    }
                });
