...
var PaymentsController = function () {
    ...
    var PaymentsController = _classThis = /** @class */ (function () {
        ...
        PaymentsController_1.prototype.initialize = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.paymentsService.initializeTransaction(data.provider, data.email, data.amount)];
                });
            });
        };
        PaymentsController_1.prototype.verify = function (provider, reference) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.paymentsService.verifyTransaction(provider, reference)];
                });
            });
        };
    ...
    (function () {
        ...
        _initialize_decorators = [(0, common_1.Post)('initialize')];
        _verify_decorators = [(0, common_1.Get)('verify')];
        __esDecorate(_classThis, null, _initialize_decorators, { kind: "method", name: "initialize", static: false, private: false, access: { has: function (obj) { return "initialize" in obj; }, get: function (obj) { return obj.initialize; } }, metadata: _metadata }, null, _instanceExtraInitializers);
