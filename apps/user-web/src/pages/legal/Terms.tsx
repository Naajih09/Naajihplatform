...
const sections = [
  {
    ...
    body: "By creating an account, browsing the platform, or using any service offered by NaajihBiz, you agree to these Terms of Service and to our Privacy Policy. If you do not agree, you should not use the platform.",
  },
  {
  ...
  },
  {
    ...
    body: "You retain ownership of content you submit, but you grant NaajihBiz a non-exclusive license to host, process, display, and distribute that content for the purpose of operating and improving the platform. You must not upload unlawful, misleading, infringing, defamatory, or harmful content.",
  },
  {
    title: "7. Prohibited behavior",
    body: "You may not attempt to reverse engineer the service, scrape data without permission, interfere with platform security, impersonate other users, bypass access controls, or use the platform in a way that could damage the service or other users.",
  },
  {
    title: "8. Fees and third-party services",
    body: "Some features may rely on third-party services such as hosting, analytics, payments, communication tools, or verification providers. Those services may have separate terms and fees. If platform fees are introduced, we will communicate them clearly before they apply.",
  },
  {
    title: "9. Suspension and termination",
    body: "We may suspend or terminate access if we reasonably believe you violated these terms, created risk for other users, or if required by law or security concerns. You may stop using the service at any time and request account deletion through support, subject to legal retention requirements.",
  },
  {
  ...
  },
  {
    ...
    body: "These terms are intended to be governed by the laws applicable in Nigeria, without regard to conflict-of-law rules, unless a separate written agreement says otherwise. If a part of these terms is unenforceable, the rest remains in effect.",
  },
  {
    title: "12. Contact",
    body: "If you have questions about these terms, contact the NaajihBiz team at support@naajihbiz.com.",
  },
];
